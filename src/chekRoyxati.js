...
export default function ChekRoyxati() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get('https://backend-rislola.onrender.com/userKvitansiya/getUsers');
        if (res.data.success) {
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axios.delete(`https://backend-rislola.onrender.com/userKvitansiya/delete/${deleteId}`);
